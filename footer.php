    ...
    <section class="under-footer">
      <div class="container">
        <div class="under-footer__wrapper">
          <div class="under-footer__links-list">
            <a href="#" class="under-footer__link">Disclaimer</a>
            <a href="#" class="under-footer__link">Conditions of use</a>
            <a href="#" class="under-footer__link">Cancellation policy</a>
          </div>
          <img
            src="img/cards.svg"
            alt="Cards"
            class="under-footer__cards-image"
          />
        </div>
      </div>
    </section>
